...
- safety-critical escalation path (vehicle-traffic hazard,
  weather/terrain-exposure hazard, equipment-condition hazard)
- provenance for all operating records (worker and route both
  independently registered)
- human review for high-risk cases
- audit export for all gated actions
- a hard, unconditional block on any attempt to route a cleaning-
  work-execution decision, a route-safety-clearance decision (e.g.
...
humans, and that no deployment configuration can route a cleaning-
work-execution decision, a route-safety-clearance decision, or a
